...
parser.add_argument('--method_name', '-m', type=str, default='resnet_cifar10_godin', help='Method name.')
# Loading details
...
if 'resnet' in args.method_name:
    underlying_net = ResNet34x(num_classes=num_classes)
else:
    underlying_net = DenseNet3x(depth=100, num_classes=num_classes)
