...
if __package__ is None:
    ...
    from utils.odin_detector import odin_score
...
# Find best noise magnitude for odin
...
for magnitude in m_list:
    ...
    for data in data_list:
        batch_score = odin_score(net, std, data, magnitude, 1000)
...
def get_ood_scores(loader, in_dist=False):
    ...
    for batch_idx, (data, target) in enumerate(loader):
        ...
        odin_scores = -odin_score(net, std, data, best_magnitude, 1000)
        _score.append(odin_scores)
        ...
        if in_dist:
            ...
            _right_score.append(odin_scores[right_indices])
            _wrong_score.append(odin_scores[wrong_indices])
...
ood_data = dset.SVHN(root='/data/share/ood_datasets/svhn/', split="test",
